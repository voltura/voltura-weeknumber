...
{
    private static readonly string[] InputCases =
    [
        "2461291a",
        "a",
        " ",
    ...
    public void NumberFieldRejectsNonAsciiDigitsFromTypingAndPaste()
    {
        fixture.Run(() =>
        {
            ...
            var source = new System.Windows.Interop.HwndSource(
                new System.Windows.Interop.HwndSourceParameters("Number input test")
            );
    ...
    private static void VerifyOrdinalInput()
    {
        ...
        year.RaiseEvent(
            new KeyboardFocusChangedEventArgs(Keyboard.PrimaryDevice, 0, year, day)
            {
