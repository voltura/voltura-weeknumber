...
internal sealed class TrayMenuRenderer(bool dark) : ToolStripProfessionalRenderer
{
    ...
    internal Color Text { get; } = dark ? Color.FromArgb(247, 242, 233) : Color.FromArgb(28, 34, 39);
    private readonly Color _raised = dark ? Color.FromArgb(32, 40, 46) : Color.FromArgb(237, 242, 245);
    private readonly Color _border = dark ? Color.FromArgb(62, 74, 82) : Color.FromArgb(211, 220, 226);
    ...
    protected override void OnRenderImageMargin(ToolStripRenderEventArgs e) => OnRenderToolStripBackground(e);
